...
if __name__ == '__main__':
    ...
    # Loading the dataset
    dataset = datasets.ImageFolder(root = './data',  transform = transform) # We download the training set in the ./data folder and we apply the previous transformations on each image.
